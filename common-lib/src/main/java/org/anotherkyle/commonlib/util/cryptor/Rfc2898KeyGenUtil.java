...
public class Rfc2898KeyGenUtil {
     ...
     */
    public Rfc2898KeyGenUtil(byte[] password, byte[] salt, int iterations) throws NoSuchAlgorithmException, InvalidKeyException {
     ...
     * @throws InvalidKeyException          Salt must be 8 bytes or more. -or- Password cannot be null.
     */
    public Rfc2898KeyGenUtil(String password, byte[] salt, int iterations) throws InvalidKeyException, NoSuchAlgorithmException {
     ...
     */
    public Rfc2898KeyGenUtil(String password, byte[] salt) throws NoSuchAlgorithmException, InvalidKeyException, UnsupportedEncodingException {
